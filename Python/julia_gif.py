...
def gif(filename,array,fps = 10, scale = 1.0):
	...
	Notes 
	-----
	works with current Githun version of moviepy (not the pip version)
	...
	scale:how much to rescale each image by (default: 1.0)
	"""
...
if __name__ == '__main__':
	...
	for i in range(0,n):
		...
		seqs[i,:,:] = np.array(img)
	print('Make gif....')
	gif('julia_gif1.gif',seqs,8)
	print('Please check the gift')